...
<script src="inst/htmlwidgets/lib/d3/d3.js" type="text/javascript" charset="utf-8"></script>


```{r, fig.cap="Ronimine meile meeldib! Ülo ja Intsu mõtisklevad möödunud päeva üle Håra lähedal laagris. Selja taga on kõigest natuke üle 60 km, aga 1260 tõusumeetrit. 17. juuli 2017.", out.width=600, echo=FALSE}
